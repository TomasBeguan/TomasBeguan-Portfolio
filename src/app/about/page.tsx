            ...
            <RetroContainer title={language === 'es' ? "Curriculum Vitae" : "Curriculum Vitae"} className="md:flex-1 md:min-h-0 md:mt-8 mb-3">
                <div className="flex flex-col md:flex-row gap-8 items-start w-full">
                    ...
                    <div className="w-full md:w-2/3 space-y-8">
                        <div>
                            <h1 className="text-4xl md:text-5xl font-chicago uppercase tracking-wider mb-1 text-black">Tomas Beguan</h1>
                        ...
                        <div className="space-y-4 font-space-grotesk font-medium text-lg">
                            <h3 className="text-2xl font-chicago border-b-2 border-black pb-1 inline-block">
                                {language === 'es' ? "Perfil" : "Profile"}
                            </h3>
                            <p>
                                {language === 'es'
                                    ? "¡Hola! Soy Tomás. Artista 3D con pasión por transformar ideas en realidad visual tangible. Me especializo principalmente en animación, modelado y shading pero tengo experiencia en el resto del workflow de una animación por software."
                                    : "Hey! I'm Tomás. I'm a digital artist obsessed with retro aesthetics, brutalism, and old-school technology. I use Blender to create immersive visual experiences that bridge the gap between nostalgia and modernism."}
                            </p>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-6">
                                <div className="border-l-4 border-black pl-4">
                                    ...
                                    <ul className="list-disc list-inside font-space-grotesk space-y-1 text-base">
